...
TRIAL_OFFERS = {
    "@AI_Automation_Hub": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@AI_Automation_Hub"]
    },
    "@EarnInTelegram": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@EarnInTelegram"]
    },
    "@CryptoAI_Guide": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@CryptoAI_Guide"]
    },
    "@SmartHabits_AI": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@SmartHabits_AI"]
    },
    "@FinAI_Guide": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@FinAI_Guide"]
    },
    "@HealthAI_Tips": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@HealthAI_Tips"]
    },
    "@GrowthAI_Hacks": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@GrowthAI_Hacks"]
    },
    "@LearnAI_Fast": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@LearnAI_Fast"]
    },
    "@MindAI_Daily": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@MindAI_Daily"]
    },
    "@TechAI_Now": {
        ...
        "full_text": DIGITAL_PRODUCTS_FULL["@TechAI_Now"]
    }
}

# Полные тексты (для продажи)
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in user_channels:
        ...
        if "бесплатно" in text:
            await update.message.reply_text(f"Вот оглавление:\n\n{TRIAL_OFFERS[channel]['outline']}")
        elif "полный" in text:
            await send_invoice(update, context, channel)

async def send_invoice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    channel = user_channels[update.effective_user.id]
...
def setup_scheduled_posts(application: Application):
    ...
    topics_map = {
        ...
        "@EarnInTelegram": "заработок через Telegram Stars",
...
if __name__ == "__main__":
    ...
    print("✅ Бот запущен: 2 поста/день + пробный гайд + Stars")
    app.run_polling()